...
if (stepper) {
  ...
  const stepperInput = document.querySelector('input'),
    stepperMinus = document.querySelector('.stepper__btn--minus'),
    stepperPlus = document.querySelector('.stepper__btn--plus');
